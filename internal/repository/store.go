...
type Store interface {
	...
	ListCardsByAuthor(authorID string, query domain.CardQuery) (domain.CardList, error)

	CreateCard(card domain.Card) (domain.Card, error)
	UpdateCard(cardID string, payload domain.Card) (domain.Card, error)
	ListCards(query domain.CardQuery) (domain.CardList, error)
	ListCardsForAdmin(query domain.CardQuery) (domain.CardList, error)
	...
	GetLatestMediaByOwnerAndRole(ownerUserID string, role domain.MediaRole) (domain.MediaFile, error)
	...
	UserHasStartedCardAccess(cardID, userID string) (bool, error)
